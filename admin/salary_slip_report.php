...
if (isset($_POST['search'])) {
    ...
    $sql = "SELECT * FROM `salary` WHERE  emp=?";
...
<tr>
    ...
    <td> <a href="#" onclick="editForm(event, <?php echo $key['id']; ?>, 'salary_slip.php')" class="btn btn-info" title="Edit Event"><i class="fas fa-print"></i></a> </td>
</tr>
