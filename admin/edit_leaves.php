                ...
                <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      foreach ($record as $res) { ?>
                        ...
                        <option value="<?php echo $res['id'] ?>" <?php if($key['user']==$res['id']){echo 'selected';}?>>
                        <?php echo $res['fname'];?>  <?php echo $res['lname'];
                                     ...
                                     <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-2">
                                            <label for="validationCustom02"> Month</label>
                                              ...
                                              <?php $date=date('F');
                                                 ?>
                                            <input type="text" class="form-control"  name="month" id="month" value="<?php echo $key['month']; ?>" readonly />
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-2">
                                    <label for="validationCustom02"> Year</label>
                                      ...
                                      <?php $ydate=date('Y');
                                                 ?>
                                            <input type="text"  class="form-control"  name="year" id="year" value="<?php echo $key['year']; ?>" readonly/>
                                    <div class="valid-feedback"></div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-2">
                                    <label for="validationCustom02">Leave Date</label>
                                    <input type="date" name="date" id="date" class="form-control mb-1" placeholder="Borrow Amount" value="<?php echo $key['date'];?>">
                                    <div class="valid-feedback"></div>
                                </div>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-2">
                                    ...
                                    <select name="l_type"  class="form-control mb-1" minlength="5" maxlength="15" required placeholder="Actual Salary">
                                        ...
                                        <option value="1" <?php if($key['type']=='1'){echo 'selected';}?>>Paid Leave </option>
                                        <option value="2" <?php if($key['type']=='2'){echo 'selected';}?>>Unpaid Leave </option>
                                        </select>
                                    <div class="valid-feedback"></div>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-2">
                                    ...
                                    <input type="text" name="total" id="lev" class="form-control mb-1 " minlength="5" maxlength="15" required placeholder="Paid Salary" readonly value="<?php echo $key['total'];?>">
                                    <div class="valid-feedback"></div>
                                    <span id="password-strength"></span>
                                </div>
                            </div>
