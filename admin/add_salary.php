    ...
    <div class="container-fluid  dashboard-content">
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <h5 class="card-header">Add Salary</h5>
                    <div class="card-body">
                        <form class="form-horizontal" action="Operation/salary.php" method="post" enctype="multipart/form-data" id="add_brand">
                            <div class="form-row">
                      ...
                      foreach ($record as $res) { ?>
                        ...
                        <?php echo $res['fname'];?>  <?php echo $res['lname'];
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-2">
                                    <label for="validationCustom02">Leaves</label>
                                    <input type="text" name="leave" id="leaves" class="form-control mb-1"  required placeholder="Enter Leave" readonly>
                                    <div class="valid-feedback"></div>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-2">
                                    ...
                                    <input type="text" name="amount" id="amount" class="form-control mb-1" placeholder="Borrow Amount" readonly>
                                    <div class="valid-feedback"></div>
                                </div>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-2">
                                    ...
                                    <input type="text" name="actual" id="actual" class="form-control mb-1" minlength="5" maxlength="15" required placeholder="Actual Salary" readonly>
                                    <div class="valid-feedback"></div>
                                    <span id="password-strength"></span>
                                </div>

                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-2">
                                    <label for="validationCustom02">Paid Salary</label>
                                    <input type="text" name="final" id="final" class="form-control mb-1" minlength="5" maxlength="15" required placeholder="Paid Salary">
                                    <div class="valid-feedback"></div>
                                    <span id="password-strength"></span>
                                </div>
...
$(document).ready(function() {
        ...
        if (userId) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (data && data.salary) {
                        $('#actual').val(data.salary);
                          $('#leaves').val(data.count);
                        calculateTotal();
                        fetchAmount(); // Fetch borrow amount after selecting fname
                    } else {
                        $('#actual').val('');
                    }
                }
    ...
    function calculateTotal() {
        ...
        var leaveDays = parseInt($('#leaves').val(), 10) || 0; // Get leave days, default to 0
            //   alert(leaveDays);
